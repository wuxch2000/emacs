  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-wuxch))
  (dictree--set-ordered-hash dict-wuxch ordered-hash))
(dictree--set-filename dict-wuxch (locate-library "dict-wuxch"))
(unless (memq dict-wuxch dictree-loaded-list) (push dict-wuxch dictree-loaded-list))
